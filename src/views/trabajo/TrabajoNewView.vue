<template>
  <div>
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="form-group">
        <label for="name">Titulo de trabajo:</label>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (!this.form.grupo) {
        this.errors.grupo = 'La grupo es obligatoria.';
      }

      if (!this.form.estudianteId) {
        this.errors.estudianteId = 'El Estudiante es obligatoria.';
      }
    ...
    save() {
      const vm = this;
      this.axios.post(this.baseUrl + "/trabajos", this.form)
