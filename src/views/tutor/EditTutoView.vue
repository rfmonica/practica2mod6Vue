  ...
  <div>
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="form-group">
        ...
        <input type="text" id="especialidad" v-model="form.especialidad" :class="{ 'is-invalid': errors.especialidad }"
...
export default {
  ...
  methods: {
    ...
    save() {
      const vm = this;
      this.axios.patch(this.baseUrl + "/tutores/" + this.item.id, this.form)
